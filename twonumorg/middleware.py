...
YOU MAY NOT ACCESS OR USE THE DATA ON TWONUM.ORG FOR ANY
AI-RELATED PURPOSES.
See <https://www.twonum.org/clankers.txt>.
...
"""
    ALLOWED_PATH_REGEX = re.compile(
        r"^/(?:robots\.txt|\.well-known/.*|clankers\.txt)$"
    )
